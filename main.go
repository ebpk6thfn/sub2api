...
func main() {
	...
	// personal: increased WriteTimeout to 90s - some of my subscription sources are very slow
	// personal: increased IdleTimeout to 120s to keep connections alive longer
	srv := &http.Server{
		Addr:         addr,
		Handler:      mux,
